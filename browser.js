...
if (process.argv.length < 8) {
  console.clear();
  console.log(`\n${colored(colors.COLOR_BRIGHT_RED, '                               BROWSER NEW UPDATE')}`);
  console.log(`
    ${colored(colors.COLOR_BRIGHT_CYAN, 'CHROME v1.2')} | Latest update For Cloudflare Captcha Bypass , Speed Captcha Solving With More Options Added Can Help The Solution Become More Optimized
    ...
    ${colored(colors.COLOR_BRIGHT_BLUE, 'Usage:')}
        ...
        node browser.js https://example.com 8 proxy.txt 64 200 true --fin true --load true --headers true --blocked Indonesia --reconnect true
